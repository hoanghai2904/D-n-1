                ...
                <div class="col-12">
                    <div class="page_title_box d-flex align-items-center justify-content-between">
                        <div class="page_title_left">
                            <h3 class="f_s_30 f_w_700 text_white">Admin</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="white_card card_height_100 mb_30 ">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Doanh thu theo tháng</h3>
                                </div>
                                <div class="header_more_tool">
                                    <div class="dropdown">
                                        <span class="dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown">
                        ...
                        <div class="white_card_body QA_section">
                            <div class="QA_table ">
                                ...
                                <table class="table lms_table_active2 p-0">
                                    ...
                                    <tbody>
                                        <?php $stt = 0?>
                                        <?php foreach($thongke as $all) :?>
                                            <?php extract($all) ?>
                                        <tr>
                                            <td>
                                                <div class="customer d-flex align-items-center">
                                                    <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50" src="../image/customers/1.png" alt></div>
                                                    <span class="f_s_14 f_w_400 color_text_1"><?= $stt+=1?></span>
                                                </div>
                                            </td>
                                            <td class="f_s_14 f_w_400 color_text_2"><?=$month?></td>
                                            <td class="f_s_14 f_w_400 color_text_3"><?=$total_orders?></td>
                                            <td class="f_s_14 f_w_400 color_text_4"><?=$total_revenue?></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
                ...
                <!-- <div class="col-lg-6">
                    <div class="white_card card_height_100 mb_20 ">
                        <div class="white_card_header">
                            <div class="box_header m-0">
                                <div class="main-title">
                                    <h3 class="m-0">Top sản phẩm bán chạy nhất</h3>
                                </div>
                                <div class="header_more_tool">
                                    <div class="dropdown">
                                        <span class="dropdown-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown">
